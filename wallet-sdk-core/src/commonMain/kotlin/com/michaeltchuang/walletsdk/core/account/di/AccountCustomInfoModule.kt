...
import com.michaeltchuang.walletsdk.core.account.data.mapper.entity.CustomAccountInfoEntityMapper
import com.michaeltchuang.walletsdk.core.account.data.mapper.entity.CustomAccountInfoEntityMapperImpl
import com.michaeltchuang.walletsdk.core.account.data.mapper.entity.CustomHdSeedInfoEntityMapper
import com.michaeltchuang.walletsdk.core.account.data.mapper.entity.CustomHdSeedInfoEntityMapperImpl
import com.michaeltchuang.walletsdk.core.account.data.mapper.model.CustomAccountInfoMapper
import com.michaeltchuang.walletsdk.core.account.data.mapper.model.CustomAccountInfoMapperImpl
import com.michaeltchuang.walletsdk.core.account.data.mapper.model.CustomHdSeedInfoMapper
import com.michaeltchuang.walletsdk.core.account.data.mapper.model.CustomHdSeedInfoMapperImpl
import com.michaeltchuang.walletsdk.core.account.data.repository.CustomAccountInfoRepositoryImpl
import com.michaeltchuang.walletsdk.core.account.data.repository.CustomHdSeedInfoRepositoryImpl
...
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.ClearAllCustomInformationUseCase
...
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.GetAccountBackUpStatus
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.GetAccountCustomInfo
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.GetAccountCustomInfoOrNull
...
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.GetAccountsCustomInfoFlow
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.GetAllAccountOrderIndexes
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.GetAllHdSeedOrderIndexes
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.GetBackedUpAccounts
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.GetHdSeedAsbBackUpStatus
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.GetHdSeedCustomInfoOrNull
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.GetHdSeedCustomName
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.GetNotBackedUpAccounts
...
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.SetAccountOrderIndex
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.SetAddressesBackedUp
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.SetHdSeedCustomInfo
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.SetHdSeedCustomName
import com.michaeltchuang.walletsdk.core.account.domain.usecase.custom.SetHdSeedOrderIndex
import com.michaeltchuang.walletsdk.core.foundation.database.AlgoKitDatabase
import org.koin.dsl.module

val accountCustomInfoModule =
    module {
