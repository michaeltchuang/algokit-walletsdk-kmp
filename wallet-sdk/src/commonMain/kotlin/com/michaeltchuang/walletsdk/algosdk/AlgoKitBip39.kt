...
internal fun getSeedFromEntropy(entropy: ByteArray): ByteArray {
    val mnemonic = MnemonicCode.toMnemonics(entropy)
    val passphrase = ""
    val seed = MnemonicCode.toSeed(mnemonic.toString(), passphrase)
    return seed
}

@OptIn(ExperimentalStdlibApi::class)
internal fun getEntropyFromMnemonic(mnemonic: String): String {
...
internal fun getMnemonicFromEntropy(entropy: ByteArray): String {
    val mnemonic = MnemonicCode.toMnemonics(entropy)
